...
C:\tibco_be\tibcojre\1.7.0\bin\java.exe -classpath .;C:\tibco\as\2.0\lib\as-common.jar;"C:\Program Files\TIBCO\terr15\library\terrJava\java\terrJava.jar";C:\Eclipse\workspace\TERR_Project\distro\lib\terr.events.jar com.tibco.terr.events.EngineStarter -props_file C:\Eclipse\workspace\TERR_Project\distro\bin\terr_events.properties