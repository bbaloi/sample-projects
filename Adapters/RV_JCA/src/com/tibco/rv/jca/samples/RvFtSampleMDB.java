 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class RvFtSampleMDB implements javax.ejb.MessageDrivenBean, RVListener
{
	/* (non-Javadoc)
	 ...
	 */
	 private static final String rbName = null; // No localization is used for logging.
		...
		private static String className = RvFtSampleMDB.class.getName();
	...
	public void onMessage(TibrvMsg pRvMsg) {
		...
		sLogger.log(Level.INFO,"In Ft MDB...");
