 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class RvBaseSampleMDB implements javax.ejb.MessageDrivenBean, RVListener
{
	/* (non-Javadoc)
	...
	private static String className = RvBaseSampleMDB.class.getName();
	...
	public void onMessage(TibrvMsg pRvMsg)
	{
		...
		sLogger.log(Level.INFO,"In Base MDB...");
