...
public class TestNoProxy extends SipTestCase
{
    ...
    // INVITE myself
    {
        try
        {
           ...
           // Request invite = ua.getParent().getMessageFactory().createRequest("INVITE sip:becky@nist.gov SIP/2.0 ");
            ...
            Request invite=ua.getParent().getMessageFactory().createRequest(addr_factory.createURI("sip:becky@nist.gov"), "INVITE", ua.getParent().getSipProvider().getNewCallId(), 
    ...
    // string
    {
        try
        {
        	System.out.println("starting testBothSides");
            SipPhone ub = sipStack.createSipPhone("sip:becky@nist.gov");
           ...
           // a.initiateOutgoingCall("sip:becky@nist.gov", null);
            a.initiateOutgoingCall("sip:becky@nist.gov", properties.getProperty("javax.sip.IP_ADDRESS")+ ':' + myPort + '/' + testProtocol);
