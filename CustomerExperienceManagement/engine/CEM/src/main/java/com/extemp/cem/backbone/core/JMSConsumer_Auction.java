...
public class JMSConsumer_Auction extends BaseEventConsumer
{
	...
	return "activemq:topic:cem.auction.bid.submission.topic";
    }

    public JMSConsumer_Auction() {
	//System.out.println("Settings - " + settings.DB_URI);
	this.uri = "activemq:topic:cem.auction.bid.submission.topic";
    }

    public JMSConsumer_Auction(String uri) {
	this.uri = uri;
    }
	...
	if (message instanceof CamelMessage) {
	   ...
	   CamelMessage msg = (CamelMessage) message;
	    ...
	    System.out.println("+++Received Auction Bid message - " + receivedMessage);
