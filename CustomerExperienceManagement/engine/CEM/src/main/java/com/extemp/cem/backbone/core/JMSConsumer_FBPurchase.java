...
public class JMSConsumer_FBPurchase extends BaseEventConsumer
{
	...
	return "activemq:topic:cem.purchase.request.queue";
    }

    public JMSConsumer_FBPurchase() {
	//System.out.println("Settings - " + settings.DB_URI);
	this.uri = "activemq:topic:cem.purchase.request.queue";
    }

    public JMSConsumer_FBPurchase(String uri) {
	this.uri = uri;
    }
	...
	if (message instanceof CamelMessage) {
	   ...
	   CamelMessage msg = (CamelMessage) message;
	    ...
	    System.out.println("+++Received F&B Purchase  message - " + receivedMessage);
