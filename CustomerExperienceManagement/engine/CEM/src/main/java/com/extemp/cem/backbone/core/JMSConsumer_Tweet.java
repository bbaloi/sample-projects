...
public class JMSConsumer_Tweet extends BaseEventConsumer
{
	...
	return "activemq:topic:cem.social.tweet.topic";
    }

    public JMSConsumer_Tweet() {
	//System.out.println("Settings - " + settings.DB_URI);
	this.uri = "activemq:topic:cem.social.tweet.topic";
    }

    public JMSConsumer_Tweet(String uri) {
	this.uri = uri;
    }
	...
	if (message instanceof CamelMessage) {
	   ...
	   CamelMessage msg = (CamelMessage) message;
	    ...
	    System.out.println("+++Received Tweet message - " + receivedMessage);
