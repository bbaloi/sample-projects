...
public class JMSConsumer_EnterpriseEvent extends BaseEventConsumer
{
	...
	return "activemq:topic:cem.ent.event.topic";
    }

    public JMSConsumer_EnterpriseEvent() {
	//System.out.println("Settings - " + settings.DB_URI);
	this.uri = "activemq:topic:cem.ent.event.topic";
    }

    public JMSConsumer_EnterpriseEvent(String uri) {
	this.uri = uri;
    }
	...
	if (message instanceof CamelMessage) {
	   ...
	   CamelMessage msg = (CamelMessage) message;
	    ...
	    System.out.println("+++Received Enterprsie Event message - " + receivedMessage);
