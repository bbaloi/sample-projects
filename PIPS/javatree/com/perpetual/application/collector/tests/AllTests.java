...
public class AllTests {
	...
	public static Test suite() {
		TestSuite suite =
			new TestSuite("Test for com.perpetual.application.collector.tests");

		suite.addTest(com.perpetual.application.collector.log.tests.AllTests.suite());
		suite.addTest(com.perpetual.application.collector.message.tests.AllTests.suite());
		suite.addTest(com.perpetual.application.collector.log.util.tests.AllTests.suite());
		suite.addTest(com.perpetual.util.queue.tests.AllTests.suite());
		suite.addTest(com.perpetual.application.collector.action.forward.tests.AllTests.suite());
		suite.addTest(com.perpetual.application.collector.action.tests.AllTests.suite());
		
		suite.addTest(new TestSuite(TestSingleCollector.class));
		suite.addTest(new TestSuite(TestForwardingCollector.class));
		return suite;
	}
}
