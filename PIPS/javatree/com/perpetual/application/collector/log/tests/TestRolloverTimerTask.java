...
import com.perpetual.application.collector.log.RolloverTimerTask;
...
public class TestRolloverTimerTask extends TestCase {
	...
	public TestRolloverTimerTask(String arg0) {
		super(arg0);
	}
	...
	{
		RolloverTimerTask rolloverTask = new RolloverTimerTask();
