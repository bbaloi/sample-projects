...
public class LogStoreManagerException extends PerpetualException {
	
	public LogStoreManagerException (String message) {
		super(message);
	}
	
	public LogStoreManagerException (Exception e) {
		super(e);
	}
}
