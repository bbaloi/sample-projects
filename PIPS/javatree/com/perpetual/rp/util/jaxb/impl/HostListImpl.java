...
public class HostListImpl implements com.perpetual.rp.util.jaxb.HostList, com.sun.xml.bind.JAXBObject, com.sun.xml.bind.RIElement, com.perpetual.rp.util.jaxb.impl.runtime.UnmarshallableObject, com.perpetual.rp.util.jaxb.impl.runtime.XMLSerializable, com.perpetual.rp.util.jaxb.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Host = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.perpetual.rp.util.jaxb.HostList.class);
    }

    public java.util.List getHost() {
        return _Host;
    }
    ...
    public com.perpetual.rp.util.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.perpetual.rp.util.jaxb.impl.runtime.UnmarshallingContext context) {
        return new com.perpetual.rp.util.jaxb.impl.HostListImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = _Host.size();
        context.startElement("", "HostList");
        int idx_0 = idx1;
        while (idx_0 != len1) {
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Host.get(idx_0 ++)));
        }
        context.endNamespaceDecls();
        int idx_1 = idx1;
        while (idx_1 != len1) {
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Host.get(idx_1 ++)));
        }
        context.endAttributes();
        while (idx1 != len1) {
            context.childAsElementBody(((com.sun.xml.bind.JAXBObject) _Host.get(idx1 ++)));
        }
        context.endElement();
    }
...
+"q\u0000~\u0000\u0018t\u0000\u001fcom.perpetual.rp.util.jaxb.Hostt\u0000+http://java.sun.co"
+"m/jaxb/xjc/dummy-elementsq\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000\bHostListt\u0000\u0000sr\u0000\"com.su"
...
+"ppppppq\u0000~\u0000\u0011ppppppppppq\u0000~\u0000\u0010pppppppppppppq\u0000~\u0000\fppppppppppq\u0000~\u0000\tp"
...
+"pppppppppppppppppppppppppppppppp"));
        ...
        extends com.perpetual.rp.util.jaxb.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.perpetual.rp.util.jaxb.impl.HostListImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("Host" == ___local)&&("" == ___uri)) {
                            _Host.add(((com.perpetual.rp.util.jaxb.impl.HostImpl) spawnChildFromEnterElement((com.perpetual.rp.util.jaxb.impl.HostImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        state = 2;
                        continue outer;
