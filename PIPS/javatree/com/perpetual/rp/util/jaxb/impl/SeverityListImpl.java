...
public class SeverityListImpl implements com.perpetual.rp.util.jaxb.SeverityList, com.sun.xml.bind.JAXBObject, com.sun.xml.bind.RIElement, com.perpetual.rp.util.jaxb.impl.runtime.UnmarshallableObject, com.perpetual.rp.util.jaxb.impl.runtime.XMLSerializable, com.perpetual.rp.util.jaxb.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Severity = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.perpetual.rp.util.jaxb.SeverityList.class);
    }

    public java.util.List getSeverity() {
        return _Severity;
    }
    ...
    public com.perpetual.rp.util.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.perpetual.rp.util.jaxb.impl.runtime.UnmarshallingContext context) {
        return new com.perpetual.rp.util.jaxb.impl.SeverityListImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = _Severity.size();
        context.startElement("", "SeverityList");
        int idx_0 = idx1;
        while (idx_0 != len1) {
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Severity.get(idx_0 ++)));
        }
        context.endNamespaceDecls();
        int idx_1 = idx1;
        while (idx_1 != len1) {
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Severity.get(idx_1 ++)));
        }
        context.endAttributes();
        while (idx1 != len1) {
            context.childAsElementBody(((com.sun.xml.bind.JAXBObject) _Severity.get(idx1 ++)));
        }
        context.endElement();
    }
...
+"q\u0000~\u0000\u0018t\u0000#com.perpetual.rp.util.jaxb.Severityt\u0000+http://java.su"
+"n.com/jaxb/xjc/dummy-elementsq\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000\fSeverityListt\u0000\u0000sr"
...
+"pppppppppppppppppppppppppppppppppppppppp"));
        ...
        extends com.perpetual.rp.util.jaxb.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.perpetual.rp.util.jaxb.impl.SeverityListImpl.this;
        }
                ...
                switch (state) {
                    case  2 :
                        if (("Severity" == ___local)&&("" == ___uri)) {
                            _Severity.add(((com.perpetual.rp.util.jaxb.impl.SeverityImpl) spawnChildFromEnterElement((com.perpetual.rp.util.jaxb.impl.SeverityImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  3 :
